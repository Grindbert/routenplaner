...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Widgets_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 23, 8)
    ...
    "Widgets\0requestFertig\0\0QPixmap*\0"
};
...
void Widgets::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->requestFertig((*reinterpret_cast< QPixmap*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Widgets::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Widgets.data,
      qt_meta_data_Widgets,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Widgets.stringdata))
