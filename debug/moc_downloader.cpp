...
QT_MOC_LITERAL(5, 50, 3)
    ...
    "Downloader\0downloaded\0\0fortsetzung\0"
    "QNetworkReply*\0rep\0"
};
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->fortsetzung((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Downloader::downloaded)) {
                *result = 0;
            }
        }
    }
